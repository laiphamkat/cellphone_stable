...
public class addItemToCartAndPerformAction {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 2: Click on label storageColorOptions (128GB)"
        ...
        "Step 3: Click on label storageColorOptions (Yellow)"
        ...
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category/button_action"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/button_action', ['button_action_internalRoleButtonName': data['button_action_internalRoleButtonName_1']]))
    }
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['button_action_internalRoleButtonName_1'] = testData.getValue('button_action_internalRoleButtonName_1', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['button_action_internalRoleButtonName_1'] = 'default_data'
