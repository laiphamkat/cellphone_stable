...
public class completeOrderAfterShippingDetails {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 15: Click on button continue to payment -> Navigate to page 'checkout page#checkout/payment'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout/button_continue_to_payment'))
        
        "Step 16: Click on button complete order"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout/button_complete_order'))
    }
