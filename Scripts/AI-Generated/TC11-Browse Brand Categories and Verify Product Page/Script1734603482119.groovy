...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/div_WelcomeMessage'))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 2-Click on div WelcomeMessage.png')

"Step 3: Hover over item object2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_home/item_object2'))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 3-Hover over item object2.png')

"Step 4: Click on link brandCategories (AppleCategory) -> Navigate to page 'category page#category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 4-Click on link brandCategories AppleCategory - Navigate to page category pagecategory.png')

"Step 5: Click on link newiPhoneModels (iPhone15PlusNew) -> Navigate to page 'product page#product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 5-Click on link newiPhoneModels iPhone15PlusNew - Navigate to page product pageproduct.png')

"Step 6: Click on label colorStorageOptions (Storage256GB)"
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 6-Click on label colorStorageOptions Storage256GB.png')

"Step 7: Click on label colorStorageOptions (ColorYellow)"
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 7-Click on label colorStorageOptions ColorYellow.png')

"Step 8: Click on button purchaseOptions (Buy) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 8-Click on button purchaseOptions Buy - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Browse Brand Categories and Verify Product Page_visual_checkpoint')
