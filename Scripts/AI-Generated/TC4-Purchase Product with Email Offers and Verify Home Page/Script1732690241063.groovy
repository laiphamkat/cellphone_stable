...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on link brandNames Samsung2 - Navigate to page category.png')

"Step 4: Click on link productModels (SamsungGalaxyZFold5) -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on link productModels SamsungGalaxyZFold5 - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on label colorStorageOptions 512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on label colorStorageOptions Blue.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Purchase Product with Email Offers and Verify Home Page_visual_checkpoint')
