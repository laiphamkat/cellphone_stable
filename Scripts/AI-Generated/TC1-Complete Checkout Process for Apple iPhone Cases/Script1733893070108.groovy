...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Click on link PlaceOrder - Navigate to page cart pagecart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on link GoToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on button ProceedToCheckout - Navigate to page checkout infocheckoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 12-Hover over div CheckoutInfo.png')
...
"Step 14: Hover over div CheckoutInfo2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo2'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 14-Hover over div CheckoutInfo2.png')
...
"Step 17: Hover over div CheckoutInfo3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo3'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 17-Hover over div CheckoutInfo3.png')
...
"Step 20: Hover over div CheckoutInfo4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo4'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 20-Hover over div CheckoutInfo4.png')
...
"Step 23: Hover over div CheckoutInfo5"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo5'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 23-Hover over div CheckoutInfo5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 25-Click on input City.png')

"Step 26: Hover over div CheckoutInfo6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo6'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 26-Hover over div CheckoutInfo6.png')
...
"Step 29: Hover over div CheckoutInfo7"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo7'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 29-Hover over div CheckoutInfo7.png')
...
"Step 33: Click on button ContinueToPayment -> Navigate to page 'checkout page#checkout/payment'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout/button_ContinueToPayment'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 33-Click on button ContinueToPayment - Navigate to page checkout pagecheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 34-Click on button CompleteOrder - Navigate to page thank you pagethank-you.png')

"Step 35: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Checkout Process for Apple iPhone Cases_visual_checkpoint')
