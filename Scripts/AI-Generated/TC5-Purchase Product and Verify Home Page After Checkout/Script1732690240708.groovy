...
"Step 2: Click on link productModels (SamsungGalaxyS23UltraSmartviewCases) -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/link_productModels"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/link_productModels', ['product_id': product_id]))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 2-Click on link productModels SamsungGalaxyS23UltraSmartviewCases - Navigate to page product.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Purchase Product and Verify Home Page After Checkout_visual_checkpoint')
