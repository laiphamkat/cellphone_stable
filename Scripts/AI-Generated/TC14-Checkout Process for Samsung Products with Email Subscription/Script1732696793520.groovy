...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 3-Click on link mobileBrands Samsung2 - Navigate to page category pagecategory.png')

"Step 4: Click on link samsungProducts (SamsungGalaxyZFold5) -> Navigate to page 'product page#product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 4-Click on link samsungProducts SamsungGalaxyZFold5 - Navigate to page product pageproduct.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product_page/label_colorStorageOption', ['label_colorStorageOption_for': label_colorStorageOption_for, 'label_colorStorageOption_internalText': label_colorStorageOption_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 5-Click on label colorStorageOption Storage512GB.png')

"Step 6: Click on label colorStorageOption (ColorBlue)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product_page/label_colorStorageOption"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product_page/label_colorStorageOption', ['label_colorStorageOption_for': label_colorStorageOption_for_1, 'label_colorStorageOption_internalText': label_colorStorageOption_internalText_1]))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 6-Click on label colorStorageOption ColorBlue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 7-Click on button purchaseOptions Increased2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 8-Click on button purchaseOptions Buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 9-Click on link PlaceAnOrder - Navigate to page cart pagecart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 10-Click on button ProceedToCheckout - Navigate to page checkout infocheckoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 11-Click on div EmailNewsOffers.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 12-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 13-Click on input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 14-Enter input value in input Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 15-Click on button ContinueToShipping.png')

"Step 16: Fill out shipping information and complete order"

fillShippingInformationAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Checkout Process for Samsung Products with Email Subscription_visual_checkpoint')
