...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Click on button quantityAdjustment IncreaseQuantity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 31-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 32-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 33: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Purchase for Samsung Galaxy S23 Ultra Case_visual_checkpoint')
