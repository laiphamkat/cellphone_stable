...
"Step 4: Click on button newPhone (NewIPhone15Plus)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'category/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_category_page/button_newPhone"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category_page/button_newPhone', ['button_newPhone_class': button_newPhone_class, 'button_newPhone_internalHasText': button_newPhone_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on button newPhone NewIPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on label colorStorageOptions Storage256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on label colorStorageOptions ColorGreen.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Complete Order for New Phone with Shipping Details_visual_checkpoint')
