...
"Step 2: Click on link samsungProducts (SamsungGalaxyS23UltraSmartviewCases) -> Navigate to page 'product/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/link_samsungProducts"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/link_samsungProducts', ['product_id': product_id]))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 2-Click on link samsungProducts SamsungGalaxyS23UltraSmartviewCases - Navigate to page product.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Order Samsung Products Directly from Product Page_visual_checkpoint')
