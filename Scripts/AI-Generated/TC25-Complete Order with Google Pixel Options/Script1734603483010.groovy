...
"Step 3: Click on link brandCategories (GooglePixel) -> Navigate to page 'category page#category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 3-Click on link brandCategories GooglePixel - Navigate to page category pagecategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 4-Click on link GooglePixel7Pro - Navigate to page product pageproduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 5-Click on button purchaseOptions Increased.png')

"Step 6: Click on button purchaseOptions (Buy3)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 6-Click on button purchaseOptions Buy3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 7-Click on link Phone - Navigate to page phone category.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 8-Click on link ByPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 9-Click on link GooglePixel8 - Navigate to page product pageproduct.png')

"Step 10: Click on label colorStorageOptions (Storage512GB)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 10-Click on label colorStorageOptions Storage512GB.png')

"Step 11: Click on label colorStorageOptions (ColorBlack)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 11-Click on label colorStorageOptions ColorBlack.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 12-Click on button purchaseOptions Buy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 13-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 14-Click on button AddToCart.png')

"Step 15: Click on label storageColorOptions (Storage512GB2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/label_storageColorOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_storageColorOptions', ['label_storageColorOptions_for': label_storageColorOptions_for]))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 15-Click on label storageColorOptions Storage512GB2.png')

"Step 16: Click on label storageColorOptions (ColorBlueTitanium)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product/label_storageColorOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product/label_storageColorOptions', ['label_storageColorOptions_for': label_storageColorOptions_for_1]))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 16-Click on label storageColorOptions ColorBlueTitanium.png')

"Step 17: Click on button Buy4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'product/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product/button_Buy4'))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 17-Click on button Buy4.png')

"Step 18: Click on link cartNavigation (GoToCart3)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 18-Click on link cartNavigation GoToCart3.png')

"Step 19: Proceed to checkout and input email for shipping again"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 20-Hover over div CheckoutInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 21-Click on input FirstName.png')

"Step 22: Hover over div CheckoutInfo7"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout/div_CheckoutInfo7'))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 22-Hover over div CheckoutInfo7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 23-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 24-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 25-Hover over div CheckoutInfo2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 26-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 27-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 28-Hover over div CheckoutInfo3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 29-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 30-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 31-Hover over div CheckoutInfo4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 32-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 33-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 34-Hover over div CheckoutInfo5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 35-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 36-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 37-Hover over div CheckoutInfo6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 38-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 39-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 40-Click on continueToPaymentButton - Navigate to page checkout pagecheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 41-Click on button CompleteOrder - Navigate to page thank you pagethank-you.png')

"Step 42: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC25-Complete Order with Google Pixel Options_visual_checkpoint')
