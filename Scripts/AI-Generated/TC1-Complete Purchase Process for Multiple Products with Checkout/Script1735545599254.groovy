...
"Step 8: Click on link iPhone15 -> Navigate to page 'product page#product/*'"
...
"Step 9: Click on label colorStorageOption (512GB)"
...
"Step 10: Click on label colorStorageOption (Green)"
...
"Step 12: Click on link Cart -> Navigate to page 'cart page#cart'"
...
"Step 13: Click on button ProceedToCheckout -> Navigate to page 'checkout info#checkout/info'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'cart?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_cart_page/button_ProceedToCheckout'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 13-Click on button ProceedToCheckout - Navigate to page checkout infocheckoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 14-Hover over div object.png')
...
"Step 16: Enter input value in input Email2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/info?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_info/input_Email'), input_Email2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 16-Enter input value in input Email2.png')

"Step 17: Click on button ContinueToShipping -> Navigate to page 'checkout page#checkout/shipping-address'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/info?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout_info/button_ContinueToShipping'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 17-Click on button ContinueToShipping - Navigate to page checkout pagecheckoutshipping-address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 18-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 20-Hover over div object2.png')

"Step 21: Enter input value in input FirstName2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_page/input_FirstName'), input_FirstName2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 21-Enter input value in input FirstName2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 22-Click on input LastName.png')

"Step 23: Hover over div object3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_page/div_object3'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 23-Hover over div object3.png')

"Step 24: Enter input value in input LastName2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_page/input_LastName'), input_LastName2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 24-Enter input value in input LastName2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 25-Click on input Address.png')

"Step 26: Hover over div object4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_page/div_object4'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 26-Hover over div object4.png')

"Step 27: Enter input value in input Address2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_page/input_Address'), input_Address2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 27-Enter input value in input Address2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 28-Click on input ZipCode.png')

"Step 29: Hover over div object5"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_page/div_object5'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 29-Hover over div object5.png')

"Step 30: Enter input value in input ZipCode2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_page/input_ZipCode'), input_ZipCode2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 30-Enter input value in input ZipCode2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 31-Click on input City.png')

"Step 32: Enter input value in input City2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_page/input_City'), input_City2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 32-Enter input value in input City2.png')

"Step 33: Hover over div object6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_checkout_page/div_object6'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 33-Hover over div object6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 34-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 35-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 36-Enter input value in input Phone2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 37-Click on button ContinueToPayment - Navigate to page checkout pagecheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 38-Click on button CompleteOrder - Navigate to page thank youthank-you.png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Purchase Process for Multiple Products with Checkout_visual_checkpoint')
