...
"Step 4: Click on link productCases (SamsungGalaxyS23UltraSmartviewCases) -> Navigate to page 'product page#product/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_category/link_productCases', ['link_productCases_class': link_productCases_class, 'link_productCases_internalRoleHeadingName': link_productCases_internalRoleHeadingName]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on link productCases SamsungGalaxyS23UltraSmartviewCases - Navigate to page product pageproduct.png')
...
"Step 9: Initiate checkout and enter email for shipping"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Adjust Quantity and Complete Order for Product Cases_visual_checkpoint')
