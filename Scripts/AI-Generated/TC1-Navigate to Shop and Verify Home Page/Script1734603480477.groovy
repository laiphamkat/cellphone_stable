...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 2-Click on header object.png')

"Step 3: Hover over header object -> Navigate to page 'checkout process#checkout/step2'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'shop?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_ecommerce/header_object'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Hover over header object - Navigate to page checkout processcheckoutstep2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Enter input value in input FullName - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Shop and Verify Home Page_visual_checkpoint')
