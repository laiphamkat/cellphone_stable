...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Hover over div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Hover over div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 12-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 13-Hover over div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 14-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 16-Hover over div object4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Hover over div object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 20-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 21-Click on input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 22-Hover over div object6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 23-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 24-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 25-Hover over div object7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 26-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 27-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 28-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 29-Click on button ContinueToPayment - Navigate to page checkoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 30-Click on button CompleteOrder - Navigate to page thank-you.png')

"Step 31: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Full Checkout Process with Shipping Information_visual_checkpoint')
