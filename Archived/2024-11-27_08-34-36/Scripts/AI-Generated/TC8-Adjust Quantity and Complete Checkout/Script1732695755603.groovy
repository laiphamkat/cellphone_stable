...
"Step 3: Click on link productCategories (CategoryApple) -> Navigate to page 'category/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on link productCategories CategoryApple - Navigate to page category.png')

"Step 4: Click on link productDetails (ProductIPhone15FineWovenCase) -> Navigate to page 'product/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on link productDetails ProductIPhone15FineWovenCase - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on label productName ProductIPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on button purchaseOptions Buy2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on link PlaceAnOrder - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on button ProceedToCheckout - Navigate to page checkoutinfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 13-Click on button ContinueToShipping - Navigate to page checkoutshipping-address.png')

"Step 14: Click on link CheckoutBackToCart -> Navigate to page '/cart'"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 14-Click on link CheckoutBackToCart - Navigate to page cart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 15-Click on button quantityAdjustment IncreaseQuantity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 16-Click on button quantityAdjustment IncreaseQuantity.png')
...
"Step 18: Fill out shipping information and complete order"

fillShippingInformationAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 19: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Adjust Quantity and Complete Checkout_visual_checkpoint')
