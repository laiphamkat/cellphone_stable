...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 2-Hover over item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 3-Click on link mobileBrands Apple - Navigate to page category pagecategory.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on button newProduct NewIPhone15Plus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on label storageColorOption Storage256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on label storageColorOption ColorGreen.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 8-Click on link PlaceAnOrder.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 11-Click on input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 12-Hover over div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 13-Enter input value in input FirstName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 14-Click on input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 15-Hover over div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 16-Enter input value in input LastName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 17-Click on input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 18-Hover over div object4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 19-Enter input value in input Address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 20-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 21-Hover over div object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 23-Enter input value in input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 24-Hover over div object6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 25-Enter input value in input City.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 26-Click on input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 27-Hover over div object7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 28-Enter input value in input State.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 29-Click on input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 30-Enter input value in input Phone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 31-Click on button ContinueToPayment - Navigate to page checkout pagecheckoutpayment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 32-Click on button CompleteOrder - Navigate to page thank you pagethank-you.png')

"Step 33: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Order New Product with Detailed Shipping Information_visual_checkpoint')
